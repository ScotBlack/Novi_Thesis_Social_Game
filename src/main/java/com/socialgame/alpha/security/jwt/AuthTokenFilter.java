...
import com.socialgame.alpha.security.UserDetailsServiceImpl;
...
/**
 * AuthTokenFilter extracts username/password from the received token using JwtUtils.java, then based on the extracted
